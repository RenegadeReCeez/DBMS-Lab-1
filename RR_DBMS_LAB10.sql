...
create or replace function PreReqsFor (int) returns int as 
$course_num$
declare
   course_num int       := $1;
begin
      select preReqNum into course_num
      from Prerequisites
...
create or replace function IsPreReqsFor (int) returns int as 
$course_num$
declare
   course_num int       := $1;
begin
      select courseNum into course_num
      from Prerequisites
